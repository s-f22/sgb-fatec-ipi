...
const Footer = () => {
  return (
    <div style={{ display: 'flex', alignItems: 'center', padding: '10px', backgroundColor: '#333', color: '#fff' }}>
      <div style={{ flex: 1 }} className='footer-mobile'>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <div>E-mail: <a href="mailto:contato@fatecipiranga.edu.br" style={{textDecoration: 'none', color: '#FFA500', fontWeight:'700'}}>contato@fatecipiranga.edu.br</a></div>
        </div>
      </div>
      <div style={{ flex: 1 }}>
        <div style={{ marginBottom: '20px' }} className='footer-mobile-social-media'>
        ...
        <div style={{ backgroundColor: '#444', padding: '10px' }} className='footer-mobile-detail'>
